...
import { Calendar, TrendingUp, DollarSign, Package, Sparkles } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/20 to-background">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-serif font-bold text-foreground mb-2">Sales Reports</h1>
          <p className="text-xl text-muted-foreground">Analyze your salon's performance with detailed insights</p>
        </div>
